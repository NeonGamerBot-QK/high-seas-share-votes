...
anon.checked = await chrome.storage.sync.get("anon").then(d=>d.anon) || false
send_to_user.checked = await chrome.storage.sync.get("send_to_user").then(d=>d.send_to_user) || false
